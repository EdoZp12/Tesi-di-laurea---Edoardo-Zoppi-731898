...
class FoodPackagingConstraintProviderTest {
    ...
    @Inject
    ConstraintVerifier<ProductionConstraintProvider, ProductionSchedule> constraintVerifier;
    ...
    void dueDateTime() {
        ...
        constraintVerifier.verifyThat(ProductionConstraintProvider::dueDateTime)
    ...
    void idealEndDateTime() {
        ...
        constraintVerifier.verifyThat(ProductionConstraintProvider::idealEndDateTime)
                .given(job1, job2, job3)
                .penalizesBy(50L);
    }
    ...
    void operatorCleaningConflict() {
        ...
        constraintVerifier.verifyThat(ProductionConstraintProvider::operatorCleaningConflict)
    ...
    void minimizeAndLoadBalanceMakeSpan() {
        ...
        constraintVerifier.verifyThat(ProductionConstraintProvider::minimizeAndLoadBalanceMakeSpan)
    ...
    void minimizeCleaningDuration() {
        ...
        constraintVerifier.verifyThat(ProductionConstraintProvider::minimizeCleaningDuration)
                .given(job1, job2, job3)
                .penalizesBy(10L);
    }
