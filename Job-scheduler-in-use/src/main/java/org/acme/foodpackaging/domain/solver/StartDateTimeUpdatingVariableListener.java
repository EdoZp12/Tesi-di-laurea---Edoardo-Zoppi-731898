...
public class StartDateTimeUpdatingVariableListener implements VariableListener<ProductionSchedule, Job> {

    @Override
    public void beforeEntityAdded(ScoreDirector<ProductionSchedule> scoreDirector, Job job) {
        // Do nothing
    }

    @Override
    public void afterEntityAdded(ScoreDirector<ProductionSchedule> scoreDirector, Job job) {
        updateStartDateTime(scoreDirector, job);
    }

    @Override
    public void beforeVariableChanged(ScoreDirector<ProductionSchedule> scoreDirector, Job job) {
        // Do nothing
    }

    @Override
    public void afterVariableChanged(ScoreDirector<ProductionSchedule> scoreDirector, Job job) {
        updateStartDateTime(scoreDirector, job);
    }

    @Override
    public void beforeEntityRemoved(ScoreDirector<ProductionSchedule> scoreDirector, Job job) {
        // Do nothing
    }

    @Override
    public void afterEntityRemoved(ScoreDirector<ProductionSchedule> scoreDirector, Job job) {
        updateStartDateTime(scoreDirector, job);
    }

    private void updateStartDateTime(ScoreDirector<ProductionSchedule> scoreDirector, Job job) {
